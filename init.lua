...
require('lazy').setup({
  ...
  --        config = function()lspconfiglspconfiglspconfig
    ...
    config = function()
      ...
      local servers = {
        ...
        zls = {
          ...
          -- If you want to use a custom ZLS binary, uncomment the cmd line below:
          -- cmd = { "/path/to/zls" },
          settings = {},
        },
      }
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'c_sharp', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'zig', 'go', 'gomod' },
